...
-keep class com.lames.standard.entity.**{*;}

#-------------------------3.与js互相调用的类------------------------
-keep class com.lames.standard.module.web.**{*;}
-keep class com.lames.standard.module.webx.**{*;}

#-------------------------4.反射相关的类和方法----------------------
-keep class com.lames.standard.network.**{*;}
...
# 保持自定义控件类不被混淆，主要是calendarView
-keep class com.lames.standard.view.**{*;}
